...
>tweetid: (Twitter unique id)""")
	...
	if selection == "Modelling":
		markup(selection)
		option = st.selectbox('Select a model',['LinearSVC','Logistic Regression', 'Random Forest'])
	...
	if selection == "Model Performance":
		...
		st.info("Model performance will be judged using two metrics the f1 score we have that logistic regresion after hyperparameter tuning gives a score of 0.78 and linearSVC gives 0.74 , with the ramdom forest giving a similar result to the logistic regression.")
